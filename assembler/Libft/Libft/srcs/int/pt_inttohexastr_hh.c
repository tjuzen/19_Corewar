...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   pt_inttohexastr_hh.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: fabbenbr <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/05/14 09:56:11 by fabbenbr          #+#    #+#             */
/*   Updated: 2019/05/14 09:56:13 by fabbenbr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../includes/libft.h"

static char	*neghex(unsigned char deci, char *h, char *temp)
{
	int		l;
	int		i;
...
static char	*poshex(unsigned char deci, char *h)
{
	int		l;
...
char		*pt_inttohexastr_hh(unsigned char deci, int i, char *h, char *temp)
{
	if ((int)deci < 0)
