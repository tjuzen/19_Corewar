...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/05/07 11:52:36 by fabbenbr          #+#    #+#             */
/*   Updated: 2019/05/07 11:52:38 by fabbenbr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../includes/libft.h"

static char	*neghex(intmax_t deci, char *hexa, char *temp)
{
	int		i;
...
static char	*poshex(intmax_t deci, char *hexa)
{
	int		l;
