...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/05/07 11:52:22 by fabbenbr          #+#    #+#             */
/*   Updated: 2019/05/14 09:56:08 by fabbenbr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../includes/libft.h"

static char	*neghex(unsigned long deci, char *hexa, char *temp)
{
	int	i;
...
static char	*poshex(unsigned long deci, char *hexa)
{
	int		l;

	l = ft_divlen_ul(deci, 16);
	l--;
	while (l >= 0)
	{
